...
import pandas as pd
Y= range(1,11)  # Исправлено: 10 лет (1-10)
...
# Столбчатые диаграммы для амортизации
plt.figure()
...
plt.title('Амортизация по 1-му способу')
...
plt.xlabel('Год')
plt.ylabel('Амортизация')
plt.title('Амортизация по 2-му способу')
